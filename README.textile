...
_Chory allows you to control a robot from an android based device_

.h3 Technology

This project consits of several different components. Each component is self contained and can be exchanged if required
